// Simplified China administrative divisions for address selection
// Format: { province: [{ name, cities: [{ name, districts: [string] }] }] }
...
export const chinaRegions: Province[] = [
  ...
  { name: '重庆市', cities: [
    { name: '重庆市', districts: ['渝中区','万州区','涪陵区','大渡口区','江北区','沙坪坝区','九龙坡区','南岸区','北碚区','渝北区','巴南区','黔江区','长寿区','江津区','合川区','永川区'] },
  ]},
  { name: '河北省', cities: [
    ...
    { name: '邯郸市', districts: ['邯山区','丛台区','复兴区','峰峰矿区','肥乡区','永年区'] },
  ]},
  { name: '山西省', cities: [
  ...
  { name: '江苏省', cities: [
    ...
    { name: '苏州市', districts: ['虎丘区','吴中区','相城区','姑苏区','吴江区'] },
  ...
  { name: '湖北省', cities: [
    { name: '武汉市', districts: ['江岸区','江汉区','硚口区','汉阳区','武昌区','青山区','洪山区','东西湖区','蔡甸区','江夏区'] },
  ]},
  { name: '湖南省', cities: [
  ...
  { name: '广东省', cities: [
    ...
    { name: '东莞市', districts: ['东城街道','南城街道','万江街道','莞城街道','虎门镇','长安镇'] },
    { name: '佛山市', districts: ['禅城区','南海区','顺德区','三水区','高明区'] },
  ]},
  { name: '广西壮族自治区', cities: [
    { name: '南宁市', districts: ['兴宁区','青秀区','江南区','西乡塘区','良庆区','邕宁区','武鸣区'] },
  ]},
  { name: '海南省', cities: [
