...
function ensureTissuePuppyArExampleUsesCurrentPlaceholder(db) {
  ...
  upsertOfficialContent(db, {
    ...
    resource: {
      ...
      mimeType: 'video/mp4',
      filename: 'ar.mp4',
      storageKey: 'ar-placeholders/ar.mp4',
      url: '/ar-placeholders/ar.mp4',
      previewUrl: '/ar-placeholders/ar.png',
      metadata: { rendererProfile: 'browser_video', appCode: 'tissue-puppy' },
    },
  });
}
